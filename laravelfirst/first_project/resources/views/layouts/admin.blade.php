    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="info">
                    <div style="color:#c2c7d0;" href="#" class="d-block"><span
                            style="cursor:default;border-bottom: 1px solid #c2c7d0;">{{auth()->user()->name}}</span>
                    </div>
                </div>
            </div>
            <!-- Sidebar Menu -->
...
<script src="{{asset("js/admin/paste.js")}}"></script>
